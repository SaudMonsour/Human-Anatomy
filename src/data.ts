...
export type Muscle = {
  ...
  family: string
  part: string
  partKind: 'head' | 'fibers' | 'region' | 'muscle'
  name: string
  function: string
  side: BodySide
  path: string
...
export const muscles: Muscle[] = [
  { id: 'chest-upper', group: 'Chest', family: 'Pectoralis major', part: 'Clavicular head', partKind: 'head', name: 'Upper chest', function: 'Raises and draws the upper arm across the body; emphasized by inclined pressing.', side: 'front', path: 'M125 185 C140 160 160 160 175 185 L166 225 C151 235 139 235 125 225 Z' },
  { id: 'chest-lower', group: 'Chest', family: 'Pectoralis major', part: 'Sternocostal head', partKind: 'head', name: 'Mid and lower chest', function: 'Draws the upper arm across and downward; emphasized by flat pressing, dips, and high-to-low flyes.', side: 'front', path: 'M125 225 C140 225 160 225 175 225 L180 275 C160 290 140 290 120 275 Z' },
  { id: 'lats', group: 'Back', family: 'Latissimus dorsi', part: 'Whole muscle', partKind: 'muscle', name: 'Latissimus dorsi', function: 'Extends and adducts the upper arm, creating the broad shape of the back.', side: 'back', path: 'M105 190 C125 180 175 180 195 190 L180 330 C160 345 140 345 120 330 Z' },
  { id: 'upper-traps', group: 'Back', family: 'Trapezius', part: 'Upper fibers', partKind: 'fibers', name: 'Upper trapezius', function: 'Elevates and upwardly rotates the shoulder blade.', side: 'back', path: 'M128 125 L172 125 L190 185 L160 175 L140 175 L110 185 Z' },
  { id: 'mid-traps', group: 'Back', family: 'Trapezius', part: 'Middle fibers', partKind: 'fibers', name: 'Middle trapezius', function: 'Retracts the shoulder blades and supports stable rowing mechanics.', side: 'back', path: 'M115 180 L185 180 L178 235 L122 235 Z' },
  { id: 'lower-traps', group: 'Back', family: 'Trapezius', part: 'Lower fibers', partKind: 'fibers', name: 'Lower trapezius', function: 'Helps depress and upwardly rotate the shoulder blade.', side: 'back', path: 'M135 220 L165 220 L175 295 L125 295 Z' },
  { id: 'rhomboids', group: 'Back', family: 'Rhomboids', part: 'Whole muscle group', partKind: 'muscle', name: 'Rhomboids', function: 'Retract and stabilize the shoulder blades.', side: 'back', path: 'M137 175 L163 175 L168 245 L132 245 Z' },
  { id: 'erectors', group: 'Back', family: 'Erector spinae', part: 'Whole muscle group', partKind: 'muscle', name: 'Erector spinae', function: 'Maintain spinal extension and resist trunk flexion.', side: 'back', path: 'M138 235 L162 235 L168 360 L132 360 Z' },
  { id: 'deltoid-anterior', group: 'Shoulders', family: 'Deltoid', part: 'Anterior head', partKind: 'head', name: 'Anterior deltoid', function: 'Raises the arm forward and assists pressing movements.', side: 'front', path: 'M104 150 C112 130 132 140 140 160 L128 205 L102 190 Z M196 150 C188 130 168 140 160 160 L172 205 L198 190 Z' },
  { id: 'deltoid-lateral', group: 'Shoulders', family: 'Deltoid', part: 'Lateral head', partKind: 'head', name: 'Lateral deltoid', function: 'Raises the arm to the side and contributes to shoulder width.', side: 'front', path: 'M98 160 C80 160 80 195 105 205 L120 185 L110 155 Z M202 160 C220 160 220 195 195 205 L180 185 L190 155 Z' },
  { id: 'deltoid-posterior', group: 'Shoulders', family: 'Deltoid', part: 'Posterior head', partKind: 'head', name: 'Posterior deltoid', function: 'Moves the arm backward and assists horizontal abduction.', side: 'back', path: 'M98 160 C80 160 80 195 105 205 L120 185 L110 155 Z M202 160 C220 160 220 195 195 205 L180 185 L190 155 Z' },
  { id: 'biceps-long', group: 'Biceps', family: 'Biceps brachii', part: 'Long head', partKind: 'head', name: 'Biceps long head', function: 'Flexes the elbow and helps turn the palm upward.', side: 'front', path: 'M108 215 L128 205 L136 285 L112 290 Z M192 215 L172 205 L164 285 L188 290 Z' },
  { id: 'biceps-short', group: 'Biceps', family: 'Biceps brachii', part: 'Short head', partKind: 'head', name: 'Biceps short head', function: 'Assists elbow flexion and forearm supination.', side: 'front', path: 'M128 205 L142 205 L148 285 L132 288 Z M172 205 L158 205 L152 285 L168 288 Z' },
  { id: 'brachialis', group: 'Biceps', family: 'Brachialis', part: 'Whole muscle', partKind: 'muscle', name: 'Brachialis', function: 'A strong elbow flexor in every forearm position.', side: 'front', path: 'M116 270 L136 265 L140 330 L120 335 Z M184 270 L164 265 L160 330 L180 335 Z' },
  { id: 'triceps-long', group: 'Triceps', family: 'Triceps brachii', part: 'Long head', partKind: 'head', name: 'Triceps long head', function: 'Extends the elbow and crosses the shoulder joint.', side: 'back', path: 'M108 210 L130 205 L137 295 L112 300 Z M192 210 L170 205 L163 295 L188 300 Z' },
  { id: 'triceps-lateral', group: 'Triceps', family: 'Triceps brachii', part: 'Lateral head', partKind: 'head', name: 'Triceps lateral head', function: 'Contributes strongly to forceful elbow extension.', side: 'back', path: 'M105 230 L122 220 L130 300 L108 305 Z M195 230 L178 220 L170 300 L192 305 Z' },
  { id: 'triceps-medial', group: 'Triceps', family: 'Triceps brachii', part: 'Medial head', partKind: 'head', name: 'Triceps medial head', function: 'Supports elbow extension throughout the movement range.', side: 'back', path: 'M122 260 L140 255 L143 315 L125 318 Z M178 260 L160 255 L157 315 L175 318 Z' },
  { id: 'forearm-flexors', group: 'Forearms', family: 'Forearm muscles', part: 'Flexor compartment', partKind: 'region', name: 'Forearm flexors', function: 'Flex the wrist and fingers and contribute to grip strength.', side: 'front', path: 'M112 300 L132 295 L126 380 L104 375 Z M188 300 L168 295 L174 380 L196 375 Z' },
  { id: 'forearm-extensors', group: 'Forearms', family: 'Forearm muscles', part: 'Extensor compartment', partKind: 'region', name: 'Forearm extensors', function: 'Extend and stabilize the wrist and fingers.', side: 'back', path: 'M112 300 L132 295 L126 380 L104 375 Z M188 300 L168 295 L174 380 L196 375 Z' },
  { id: 'abs-upper', group: 'Core', family: 'Rectus abdominis', part: 'Upper region', partKind: 'region', name: 'Upper rectus abdominis', function: 'Flexes the trunk and brings the ribs toward the pelvis.', side: 'front', path: 'M138 230 L162 230 L166 285 L134 285 Z' },
  { id: 'abs-lower', group: 'Core', family: 'Rectus abdominis', part: 'Lower region', partKind: 'region', name: 'Lower rectus abdominis', function: 'Supports trunk flexion and posterior pelvic control.', side: 'front', path: 'M134 285 L166 285 L168 345 L132 345 Z' },
  { id: 'obliques', group: 'Core', family: 'Obliques', part: 'Whole muscle group', partKind: 'muscle', name: 'Obliques', function: 'Rotate, laterally flex, and stabilize the trunk.', side: 'front', path: 'M120 255 L138 270 L130 345 L110 320 Z M180 255 L162 270 L170 345 L190 320 Z' },
  { id: 'quad-rectus', group: 'Quadriceps', family: 'Quadriceps', part: 'Rectus femoris', partKind: 'muscle', name: 'Rectus femoris', function: 'Extends the knee and also crosses the hip.', side: 'front', path: 'M130 345 L148 340 L150 455 L125 455 Z M170 345 L152 340 L150 455 L175 455 Z' },
  { id: 'quad-lateral', group: 'Quadriceps', family: 'Quadriceps', part: 'Vastus lateralis', partKind: 'muscle', name: 'Vastus lateralis', function: 'A large lateral knee extensor.', side: 'front', path: 'M112 350 L132 345 L130 455 L108 445 Z M188 350 L168 345 L170 455 L192 445 Z' },
  { id: 'quad-medial', group: 'Quadriceps', family: 'Quadriceps', part: 'Vastus medialis', partKind: 'muscle', name: 'Vastus medialis', function: 'Extends the knee and supports medial patellar control.', side: 'front', path: 'M132 420 L150 410 L150 470 L128 468 Z M168 420 L150 410 L150 470 L172 468 Z' },
  { id: 'quad-intermedius', group: 'Quadriceps', family: 'Quadriceps', part: 'Vastus intermedius', partKind: 'muscle', name: 'Vastus intermedius', function: 'A deep quadriceps muscle that extends the knee.', side: 'front', path: 'M138 350 L162 350 L162 440 L138 440 Z' },
  { id: 'ham-biceps', group: 'Hamstrings', family: 'Hamstrings', part: 'Biceps femoris', partKind: 'muscle', name: 'Biceps femoris', function: 'Flexes the knee and assists hip extension.', side: 'back', path: 'M110 350 L135 345 L140 455 L115 455 Z M190 350 L165 345 L160 455 L185 455 Z' },
  { id: 'ham-semitendinosus', group: 'Hamstrings', family: 'Hamstrings', part: 'Semitendinosus', partKind: 'muscle', name: 'Semitendinosus', function: 'Flexes the knee and extends the hip.', side: 'back', path: 'M135 350 L148 345 L150 455 L132 455 Z M165 350 L152 345 L150 455 L168 455 Z' },
  { id: 'ham-semimembranosus', group: 'Hamstrings', family: 'Hamstrings', part: 'Semimembranosus', partKind: 'muscle', name: 'Semimembranosus', function: 'A medial hamstring supporting knee flexion and hip extension.', side: 'back', path: 'M125 360 L140 350 L145 455 L125 455 Z M175 360 L160 350 L155 455 L175 455 Z' },
  { id: 'glute-max', group: 'Glutes', family: 'Gluteal muscles', part: 'Gluteus maximus', partKind: 'muscle', name: 'Gluteus maximus', function: 'The primary hip extensor and a powerful lower-body driver.', side: 'back', path: 'M110 325 C125 300 140 315 150 335 C160 315 175 300 190 325 L185 390 C165 405 135 405 115 390 Z' },
  { id: 'glute-med', group: 'Glutes', family: 'Gluteal muscles', part: 'Gluteus medius', partKind: 'muscle', name: 'Gluteus medius', function: 'Abducts the hip and stabilizes the pelvis during single-leg work.', side: 'back', path: 'M105 300 C120 280 138 285 150 310 L135 350 L110 345 Z M195 300 C180 280 162 285 150 310 L165 350 L190 345 Z' },
  { id: 'calf-medial', group: 'Calves', family: 'Calf complex', part: 'Medial gastrocnemius head', partKind: 'head', name: 'Medial gastrocnemius', function: 'Plantarflexes the ankle with the knee extended.', side: 'back', path: 'M125 450 L150 445 L150 555 L125 550 Z' },
  { id: 'calf-lateral', group: 'Calves', family: 'Calf complex', part: 'Lateral gastrocnemius head', partKind: 'head', name: 'Lateral gastrocnemius', function: 'Contributes to ankle plantarflexion and knee stability.', side: 'back', path: 'M150 445 L175 450 L175 550 L150 555 Z' },
  { id: 'soleus', group: 'Calves', family: 'Calf complex', part: 'Soleus', partKind: 'muscle', name: 'Soleus', function: 'A deep plantarflexor emphasized when the knee is bent.', side: 'back', path: 'M130 500 L150 495 L150 575 L128 570 Z M150 495 L170 500 L172 570 L150 575 Z' },
]
...
export const targetsForFamily = (family: string) =>
  muscles.filter((item) => item.family === family)
